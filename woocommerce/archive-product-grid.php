...
function oncore_style_catalog() {
    wp_enqueue_style('oncore_style', get_stylesheet_directory_uri() . '/css/catalog_grid.css' );
                    ...
                    <div class="span3 item">
                        ...
                        ?>
                            ...
                            if ( $cart_product ['product_id'] == $product->id ) {
                                ?>
                                <a href="<? echo $woocommerce->cart->get_cart_url();?>" class="product_in_cart">В КОРЗИНЕ</a>
                                <?
                            }
                            else {
                                ?>
                                <button type="submit" class="not_buy">КУПИТЬ</button>
                            ...
                            if ( $cart_product ['product_id'] == $product->id ) {
                                ...
                                ?>
                                <button type="submit" <? echo $add_cart_url;?>  class="buy">КУПИТЬ</button>
                                <?php
                            }
                            ?>
                            <?
        ...
        $('button.buy').click(function(event) {
            ...
            $.ajax({
                ...
                success: function(){
                    ...
                    result+1;
                    $('.counts_mini_cart span').html(result-1);
